...
//    }
     ...
     * {@inheritdoc}
     *
     * Файл передается каждому зарегистрированному guesser MIME-типа в обратном порядке
     * их регистрации (сначала запрашивается последняя регистрация). Угадав
     * возвращает значение, которое не равно null, этот метод завершается и возвращает значение.
     */
    public function guessMimeType(string $path): ?string
    {
        ...
        if (!$this->isGuesserSupported()) {
            throw new LogicException('Невозможно угадать тип MIME, так как нет доступных guesser.');
        }
    ...
    /**
     * Карта типов MIME и их расширений по умолчанию.
     *
     */
    private const MAP = [
        ...
        'application/octet-stream' => [
            'bin', 'dms', 'lrf', 'mar', 'so', 'dist', 'distz', 'pkg', 'bpk', 'dump', 'elc', 'deploy', 'exe', 'dll',
            'deb', 'dmg', 'iso', 'img', 'msi', 'msp', 'msm', 'buffer',
        ],
        'application/oda' => ['oda'],
    ...
    private const REVERSE_MAP = [
        ...
        '3ga' => [
            'audio/3gpp', 'audio/3gpp-encrypted', 'audio/x-rn-3gpp-amr', 'audio/x-rn-3gpp-amr-encrypted',
            'audio/x-rn-3gpp-amr-wb', 'audio/x-rn-3gpp-amr-wb-encrypted', 'video/3gp', 'video/3gpp',
        ...
        'asc' => [
            'application/pgp', 'application/pgp-encrypted', 'application/pgp-keys', 'application/pgp-signature',
            'text/plain',
        ],
        ...
        'astc' => ['image/astc'],
        'asx' => [
            'application/x-ms-asx', 'audio/x-ms-asx', 'video/x-ms-asf', 'video/x-ms-wax', 'video/x-ms-wmx',
            'video/x-ms-wvx',
        ],
        ...
        'cdr' => [
            'application/cdr', 'application/coreldraw', 'application/vnd.corel-draw', 'application/x-cdr',
            'application/x-coreldraw', 'image/cdr', 'image/x-cdr', 'zz-application/zz-winassoc-cdr',
        ],
        'cdx' => ['chemical/x-cdx'],
        ...
        'class' => [
            'application/java', 'application/java-byte-code', 'application/java-vm', 'application/x-java',
            'application/x-java-class', 'application/x-java-vm',
        ],
        ...
        'dbf' => [
            'application/dbase', 'application/dbf', 'application/vnd.dbf', 'application/x-dbase', 'application/x-dbf',
        ],
        ...
        'icb' => [
            'application/tga', 'application/x-targa', 'application/x-tga', 'image/targa', 'image/tga', 'image/x-icb',
        ...
        'icns' => ['image/x-icns'],
        'ico' => [
            'application/ico', 'image/ico', 'image/icon', 'image/vnd.microsoft.icon', 'image/x-ico', 'image/x-icon',
            'text/ico',
        ],
        ...
        'iso' => [
            'application/x-cd-image', 'application/x-dreamcast-rom', 'application/x-gamecube-iso-image',
            'application/x-gamecube-rom', 'application/x-iso9660-image', 'application/x-saturn-rom',
            'application/x-sega-cd-rom', 'application/x-sega-pico-rom', 'application/x-wbfs', 'application/x-wia',
        ...
        'm3a' => ['audio/mpeg'],
        'm3u' => [
            'audio/x-mpegurl', 'application/m3u', 'application/vnd.apple.mpegurl', 'audio/m3u', 'audio/mpegurl',
            'audio/x-m3u', 'audio/x-mp3-playlist',
        ],
        'm3u8' => [
            'application/m3u', 'application/vnd.apple.mpegurl', 'audio/m3u', 'audio/mpegurl', 'audio/x-m3u',
        ...
        'mdb' => [
            'application/x-msaccess', 'application/mdb', 'application/msaccess', 'application/vnd.ms-access',
            'application/vnd.msaccess', 'application/x-mdb', 'zz-application/zz-winassoc-mdb',
        ],
        ...
        'mp+' => ['audio/x-musepack'],
        'mp2' => [
            'audio/mp2', 'audio/mpeg', 'audio/x-mp2', 'video/mpeg', 'video/mpeg-system', 'video/x-mpeg',
            'video/x-mpeg-system', 'video/x-mpeg2',
        ],
        ...
        'oga' => [
            'audio/ogg', 'audio/vorbis', 'audio/x-flac+ogg', 'audio/x-ogg', 'audio/x-oggflac', 'audio/x-speex+ogg',
            'audio/x-vorbis', 'audio/x-vorbis+ogg',
        ],
        'ogex' => ['model/vnd.opengex'],
        'ogg' => [
            'audio/ogg', 'audio/vorbis', 'audio/x-flac+ogg', 'audio/x-ogg', 'audio/x-oggflac', 'audio/x-speex+ogg',
            'audio/x-vorbis', 'audio/x-vorbis+ogg', 'video/ogg', 'video/x-ogg', 'video/x-theora', 'video/x-theora+ogg',
        ],
        ...
        'pdb' => [
            'application/vnd.palm', 'application/x-aportisdoc', 'application/x-palm-database', 'application/x-pilot',
        ],
        ...
        'pot' => [
            ...
            'application/x-mspowerpoint', 'text/x-gettext-translation-template', 'text/x-pot',
        ],
        ...
        'prc' => [
            'application/vnd.palm', 'application/x-mobipocket-ebook', 'application/x-palm-database',
            'application/x-pilot',
        ],
        ...
        'psd' => [
            'application/photoshop', 'application/x-photoshop', 'image/photoshop', 'image/psd',
            'image/vnd.adobe.photoshop', 'image/x-photoshop', 'image/x-psd',
        ],
        ...
        'rms' => [
            'application/vnd.jcp.javame.midlet-rms', 'application/vnd.rn-realmedia', 'application/vnd.rn-realmedia-vbr',
        ],
        ...
        'sdp' => [
            'application/sdp', 'application/vnd.sdp', 'application/vnd.stardivision.impress', 'application/x-sdp',
        ],
        ...
        'spl' => [
            'application/futuresplash', 'application/vnd.adobe.flash.movie', 'application/x-futuresplash',
        ...
        'stylus' => ['text/stylus'],
        'sub' => [
            'image/vnd.dvb.subtitle', 'text/vnd.dvb.subtitle', 'text/x-microdvd', 'text/x-mpsub', 'text/x-subviewer',
        ],
        ...
        'vlc' => [
            'application/m3u', 'audio/m3u', 'audio/mpegurl', 'audio/x-m3u', 'audio/x-mp3-playlist', 'audio/x-mpegurl',
        ],
        'vmdk' => ['application/x-virtualbox-vmdk', 'application/x-vmdk-disk'],
        'vob' => [
            'video/mpeg', 'video/mpeg-system', 'video/x-mpeg', 'video/x-mpeg-system', 'video/x-mpeg2', 'video/x-ms-vob',
        ],
        'voc' => ['audio/x-voc'],
        ...
        'vst' => [
            'application/tga', 'application/vnd.visio', 'application/x-targa', 'application/x-tga', 'image/targa',
            'image/tga', 'image/x-icb', 'image/x-targa', 'image/x-tga',
        ],
        ...
        'wax' => [
            'application/x-ms-asx', 'audio/x-ms-asx', 'audio/x-ms-wax', 'video/x-ms-wax', 'video/x-ms-wmx',
            'video/x-ms-wvx',
        ],
        ...
        'wk1' => [
            'application/lotus123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123',
            'application/x-lotus123', 'zz-application/zz-winassoc-123',
        ],
        'wk3' => [
            'application/lotus123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123',
            'application/x-lotus123', 'zz-application/zz-winassoc-123',
        ...
        'wks' => [
            'application/lotus123', 'application/vnd.lotus-1-2-3', 'application/vnd.ms-works', 'application/wk1',
            'application/x-123', 'application/x-lotus123', 'zz-application/zz-winassoc-123',
        ],
        'wm' => ['video/x-ms-wm'],
        'wma' => ['audio/x-ms-wma', 'audio/wma'],
        'wmd' => ['application/x-ms-wmd'],
        'wmf' => [
            'application/wmf', 'application/x-msmetafile', 'application/x-wmf', 'image/wmf', 'image/x-win-metafile',
            'image/x-wmf',
        ],
